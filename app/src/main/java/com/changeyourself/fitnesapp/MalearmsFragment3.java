...
public class MalearmsFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_malearms3, container, false);
        imageViewgotoyoutube=(ImageView) view.findViewById(R.id.imageViewgotomalearmsYoutube3);
