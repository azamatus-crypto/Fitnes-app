...
public class MalearmsFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_malearms4, container, false);
        imageViewgotoyoutube=(ImageView) view.findViewById(R.id.imageViewgotomalearmsYoutube4);
