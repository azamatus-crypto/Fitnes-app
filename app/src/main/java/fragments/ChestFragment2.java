...
public class ChestFragment2 extends Fragment {
   ...
   private ImageView imageViewgotochestYoutube;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_chest2, container, false);
        imageViewgotochestYoutube=(ImageView) view.findViewById(R.id.imageViewgotomalechestYoutube2);
