...
public class MaleButtsFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_male_butts3, container, false);
        imageViewbuutsyoutube=(ImageView) view.findViewById(R.id.imageViewgotomalebuttYoutube3);
