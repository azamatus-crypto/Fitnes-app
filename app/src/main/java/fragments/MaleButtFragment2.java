...
public class MaleButtFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_male_butt2, container, false);
        imageViewbuutsyoutube=(ImageView) view.findViewById(R.id.imageViewgotomalebuttYoutube2);
